		...
		<div class="m_right">
           ...
           <form action="guser_setGuserInfo.action" method="post"  namespace="/">
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;" cellspacing="0" cellpadding="0">
              <tr>
                <td width="40%">用户ID：<span style="color:#555555;" > <input type="text"  value="${guser.guserid }"  name="gid" readonly="true" ></input></span></td>
            ...
            <center>
             <input type="submit" value="提交" class="log_btn"/></center>
            </form>
